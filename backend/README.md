...
## Project Structure
    ...
    ├── testapiautosetting_115903  # Django project configurations
...
1. Clone this repo and `cd testapiautosetting_115903`
...
2. Clone this repo and `cd testapiautosetting_115903`
